...
import { Building2, Upload, Search, FileText, Calendar, Download, Trash2, Loader2 } from 'lucide-react';
...
const FirmDocuments = () => {
  ...
  const { data: firmDocuments = [], isLoading, refetch } = useQuery({
  ...
  const filteredDocuments = firmDocuments.filter(doc => 
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold">Firm Documents</h1>
          </div>
          <Button 
        ...
        <p className="text-lg mb-6 text-muted-foreground">
          Manage and access documents shared across your firm. These documents are available to all firm members.
        </p>
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-lg">Loading firm documents...</p>
          </div>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-medium mb-2">
              {searchTerm ? 'No documents match your search' : 'No firm documents yet'}
            </h3>
            <p className="text-muted-foreground mb-4">
              {searchTerm 
                ? 'Try adjusting your search terms.' 
                : 'Upload your first firm document to get started.'
              }
            </p>
            {!searchTerm && (
              <Button 
